...
def lemmatize(sentence, tagger):
    """ Lemmatizes a single sentence string and returns it as a string.
        :arg
...
if __name__ == '__main__':
    ...
    with open("/home/pia/Schreibtisch/CLUWLL-Project/B1B2_lemmas_list_updated_SET.txt") as lemma_file:
    ...
    #dict_to_csv(lemma_context, "/home/pia/Schreibtisch/CLUWLL-Project/preprocessing_tatoeba/context_sentences_B1B2.csv")



    # converts dictionary to csv file - USE TO TEST FOR LEMMAS THAT HAVE FEWER THAN X CONTEXT SENTENCES
    out_file = "/home/pia/Schreibtisch/CLUWLL-Project/preprocessing_tatoeba/B1B2_lemmas_with_less_than_6_context_sentences.csv"
